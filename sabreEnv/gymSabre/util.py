...
class Util:
    ...
    def clientCsvExport(self, stepData):
        allClientKeys = ['id','location','episode','gymTime','qoe','estimate','manifest','alive','edgeServer_location','status','size','edgeServer_id','download_time','total_play_time_chunks','total_play_time','total_played_utility','total_log_bitrate_change','total_reaction_time','time_average_played_utility','time_average_rebuffer_events','time_average_score','buffer_size','total_rebuffer_events','time_average_played_bitrate','time_average_log_bitrate_change','rebuffer_ratio','total_bitrate_change','time_average_bitrate_change','total_played_bitrate','time_average_rebuffer','total_rebuffer', 'delay', 'latency', 'bandwidth']
